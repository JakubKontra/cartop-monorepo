...
export const LostPasswordTemplate = ({
      ...
      <Container className="mx-auto max-w-2xl bg-white rounded-lg border border-gray-200 w-full">
        ...
        <Section className="px-6 py-6" style={{ padding: "24px 16px" }}>
          ...
          <Text className="text-gray-700 text-base leading-6 mb-4">
            Nedávno jste požádali o&nbsp;obnovení hesla k&nbsp;vašemu účtu Cartop.cz. Pro
            jeho obnovení použijte tlačítko níže. Tento odkaz pro reset hesla je
