...
interface AllBrandsSectionErrorProps {
  error: Error;
  reset: () => void;
}

export const AllBrandsSectionError = ({ error, reset }: AllBrandsSectionErrorProps) => {
  ...
  return (
    <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-red-500/20 bg-red-500/5 p-8 text-center">
      ...
      <h3 className="mb-2 text-xl font-semibold text-gunmetal">Nepodařilo se načíst značky</h3>
